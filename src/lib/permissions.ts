...
export const Permissions = {
  ...
  ADD_CLAIMRESPONSE: "add_claimresponse",
  CHANGE_CLAIMRESPONSE: "change_claimresponse",
  DELETE_CLAIMRESPONSE: "delete_claimresponse",
  VIEW_CLAIMRESPONSE: "view_claimresponse",
  ADD_STUDENTCLAIM: "add_studentclaim",
  CHANGE_STUDENTCLAIM: "change_studentclaim",
  DELETE_STUDENTCLAIM: "delete_studentclaim",
  VIEW_STUDENTCLAIM: "view_studentclaim",
} as const;
