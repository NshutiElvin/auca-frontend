...
import SelectDate from "../../schedule/_components/add-event-components/select-date";
...
export default function AddEventModal({
  ...
  return (
    <form className="flex flex-col gap-4 p-4 sm:max-w-[800px] max-h-[90vh] overflow-y-auto " onSubmit={handleSubmit(onSubmit)}>
      {CustomAddEventModal ? (
