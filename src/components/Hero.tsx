...
export const Hero = () => {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center overflow-hidden mt-[60px] px-2  w-full"
    >
          ...
          <main className="space-y-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight">
              <span className="inline-block">
                <span className="inline bg-gradient-to-r from-[#6a6b98] to-[#173f72] text-transparent bg-clip-text">
                  Say
                </span>{" "}
