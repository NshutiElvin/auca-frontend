            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex rounded-full border overflow-hidden">
                  <Button
                    onClick={exportData}
                    className="flex items-center space-x-2 px-3 py-1 bg-green-950 hover:bg-green-800 rounded-none first:rounded-l-full text-sm"
                    variant="outline"
                  >
                  ...
                  <PanelGroup direction="horizontal">
                    ...
                    >
                      <div className="text-center space-y-4 p-4 flex items-center justify-between  bg-gray-800 w-full">
                        ...
                        <Button
                          className="ring-offset-background focus:ring-ring text-white absolute top-1 right-8 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
                          variant={"secondary"}
          ...
          {showStudentModal && (
            <div>
              ...
              >
                <div
                  ref={studentModalRef}
                  className={`bg-background border animate-in border-gray-800 shadow-gray-800 p-2 z-50 relative  w-fit hover:z-[55] rounded-lg shadow-lg duration-200`}
                  style={{
                    position: "fixed",
                    maxHeight: "80vh",
                    top: "10%",
