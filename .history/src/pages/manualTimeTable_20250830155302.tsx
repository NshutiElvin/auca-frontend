...
function ManualTimeTable() {
  ...
  <style>
    ...
    .text-center.py-2.px-2.bg-primary {
      padding: 0.75rem 1rem;
    }
    
    .text-center.py-2.px-2.bg-primary h2 {
      font-size: 1.125rem;
      font-weight: 600;
      margin-bottom: 0.25rem;
    }
    
    .text-center.py-2.px-2.bg-primary p {
      font-size: 0.875rem;
      opacity: 0.9;
    }
    ...
    .relative.inline-flex.items-center.justify-center.w-10.h-10.rounded-full.border {
      border: 1px solid #e5e7eb;
      transition: all 0.2s ease;
    }
    
    .relative.inline-flex.items-center.justify-center.w-10.h-10.rounded-full.border:hover {
      border-color: #3b82f6;
    ...
    .w-full.pl-10.pr-4.py-2.border.border-primary.rounded-lg {
      padding-top: 0.6rem;
      padding-bottom: 0.6rem;
    }
    
    /* Improved scroll area */
    .h-\\[70vh\\].rounded-md.border.p-4.space-y-2 {
      padding: 1.25rem;
    }
    
    /* Better exam card styling */
    .p-3.mt-3.rounded-xl.border.border-primary.shadow-sm.bg-white {
      padding: 1rem;
      margin-top: 0.75rem;
    }
    
    /* Improved modal positioning */
    .bg-background.rounded-lg.z-50.relative.shadow-md.w-\\[500px\\] {
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
    }
    
    /* Better spacing for exam groups */
    .flex.flex-wrap.justify-center.items-center.gap-2.mt-3 {
      margin-top: 0.75rem;
    }
    ...
    /* Better spacing for dialog content */
    .grid.gap-4.py-4 {
      padding-top: 1rem;
      padding-bottom: 1rem;
    }
    ...
    .sm\\:max-w-\\[600px\\].md\\:max-w-\\[800px\\].lg\\:max-w-\\[900px\\].max-h-\\[90vh\\].flex-col {
      border-radius: 0.75rem;
    }
    
    /* Better badge appearance */
    .Badge {
      font-size: 0.75rem;
    ...
    /* Improved spacing for unscheduled courses section */
    .lg\\:col-span-1 {
      margin-right: 0.5rem;
    }
    ...
    /* Improved spacing for dialog options */
    .DialogContent .grid.gap-4.py-4 {
      padding: 1.5rem;
    }
    ...
    .text-gray-500.hover\\:text-red-600.hover\\:bg-red-50.border-primary.h-6.w-6.p-0 {
      width: 1.75rem;
      height: 1.75rem;
    }
    
    /* Better modal header */
    .p-3.border-b.flex.justify-between.items-center.drag-handle {
      padding: 0.875rem 1rem;
    }
    
    /* Improved spacing for more exams modal */
    .p-3.space-y-2.drag-handle {
      padding: 1rem;
    }
    
    /* Better conflict list styling */
    .max-h-\\[200px\\].rounded-md.border .p-4.space-y-2 {
      padding: 1rem;
    }
    ...
    /* Improved button grouping in footer */
    .DialogFooter .flex.gap-3 {
      gap: 0.75rem;
    }
    ...
    >
      ...
      >
        ...
        {unscheduledExams.length > 0 && showUnscheduled && (
          <div className="lg:col-span-1">
            <div className="rounded-md shadow-lg p-4 sticky top-3">
          ...
          <div className="flex justify-center items-center mt-3">
            ...
            loading unscheduled exam ...
              ...
              <ScrollArea className="h-[70vh] rounded-md border p-4 space-y-3 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 w-full gap-4 lg:col-span-2">
          {scheduledExams.map((date, idx) => {
            ...
            return (
              ...
              >
                <div className="text-center py-3 px-3 bg-primary border-b sticky top-0 z-10 text-white">
                  ...
                  <div className="space-y-2 p-2">
                    {date.exams.map((slot, slotIdx) => (
                      ...
                      >
                        ...
                        <Badge
                          variant={"secondary"}
                          className="items-center w-full py-1"
                        >
                          {slot.start} - {slot.end}
                        </Badge>
                        ...
                        <div
                          className={`
                relative min-h-[90px] cursor-pointer transition-all duration-200 w-full
                ${
                  slot.exams
                    ? "bg-inherit"
                            ...
                            <div className="p-3 space-y-2 w-full">
                              <div className="flex justify-between items-start mb-2">
                                ...
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="text-gray-500 hover:text-red-600 hover:bg-red-50 border-primary h-7 w-7 p-0 transition-colors duration-200"
                                >
                                  <X className="w-3 h-3" />
                                </Button>
                              </div>
      ...
      {showMore && (
        <div>
          ...
          >
            <div
              ref={modalRef}
              className={`bg-background rounded-lg z-50 relative shadow-md w-[500px] hover:z-[55] shadow-primary border animate-in border-primary shadow-primary hover:z-[55] rounded-lg shadow-lg duration-200 ${
                serverLoadingMessage?.isServerLoading &&
            ...
            >
              <div
                className="p-3 border-b flex justify-between items-center drag-handle cursor-move hover:shadow-lg transition-all duration-200"
              >
      ...
      {dialogOption?.option == "conflict" && (
        <DialogContent className="sm:max-w-[600px] md:max-w-[800px] lg:max-w-[900px] max-h-[90vh] flex-col">
          ...
          <DialogHeader className="text-center space-y-3 pb-4 flex-shrink-0 p-4">
