...
const OccupanciesPage = () => {
  ...
  return (
    ...
    >
                <ResizablePanel defaultSize={50} className="drag-handle bg-gray-50 px-6 py-4 border-b border-gray-200 cursor-move flex flex-col items-center justify-between">
