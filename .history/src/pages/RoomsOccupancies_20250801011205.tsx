          ...
          {showModal && (
            <div>
              ...
              >
                <div
                  ref={modalRef}
                   className={`bg-background border border-gray-800 shadow-gray-800 rounded-lg  z-50 relative shadow-lg w-fit hover:z-[55] ${showModal? "animate-in":"animate-out fade-out-0 zoom-out-95"} max-w-[calc(100%)] rounded-lg border shadow-lg duration-200 sm:max-w-lg`}
                  style={{
                    position: "fixed",
                    maxHeight: "80vh",
                    top: "25%",
