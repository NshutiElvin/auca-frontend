...
const BulkUpload = () => {
  ...
  const floatingIcons = [
    { icon: FileText, position: { top: '20%', left: '15%' } },
    { icon: File, position: { top: '15%', right: '20%' } },
    { icon: Users, position: { top: '35%', right: '15%' } },
    { icon: Database, position: { bottom: '30%', left: '12%' } },
    { icon: Wifi, position: { bottom: '25%', right: '18%' } },
    { icon: Briefcase, position: { bottom: '40%', left: '20%' } }
  ];
      ...
      <div className="flex items-center justify-between p-6 border-b border-gray-800">
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-semibold">Webflow INC</span>
          </div>
          <div className="flex items-center space-x-1 ml-8">
            <button className="px-4 py-2 bg-white text-black rounded-full text-sm font-medium">
              Overview
            </button>
            <button className="px-4 py-2 text-gray-400 text-sm font-medium hover:text-white">
              Employees
            </button>
            <button className="px-4 py-2 text-gray-400 text-sm font-medium hover:text-white">
              Digital Cards
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <input
              ...
              className="bg-gray-800 text-white px-4 py-2 rounded-lg pl-10 w-64"
            />
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm">Joy Philip</span>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none">
              <svg className="w-full h-full opacity-20">
                ...
                <path d="M 100 80 Q 200 50 300 80 T 500 80" stroke="url(#dots)" strokeWidth="2" fill="none" />
                <path d="M 150 200 Q 250 170 350 200 T 550 200" stroke="url(#dots)" strokeWidth="2" fill="none" />
              </svg>
            </div>
                  ...
                  >
                    ...
                    <div className="flex items-center">
                      <div className="flex space-x-1">
                        {renderStars(employee.accessLevel)}
                      </div>
