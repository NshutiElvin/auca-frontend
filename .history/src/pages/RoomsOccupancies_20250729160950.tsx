          ...
          <div className="p-6">
            <div className="bg-white rounded-lg border border-gray-800 overflow-hidden">
              ...
              <div className="flex border-b border-gray-800">
                <div className="w-16 p-3 bg-gray-50 font-medium text-sm text-gray-900 border-r border-gray-800">
                  Rooms
                </div>
              ...
              <div className="divide-y divide-gray-800">
                {uniqueRooms.map((room) => (
                  <div key={room} className="flex">
                    <div className="w-16 p-3 bg-gray-50 flex items-center justify-center border-r border-gray-800">
                      <div className="flex items-center space-x-2">
