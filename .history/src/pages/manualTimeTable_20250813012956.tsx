                        ...
                        {date.exams.map((slot, slotIdx) => (
                          ...
                          >
                            <div className="p-3 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 flex justify-between">
                              ...
                              <div className="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 border border-blue-200 dark:border-blue-700">
                                {slot.start} - {slot.end}
                              </div>
                              <Button
                                variant={"ghost"}
