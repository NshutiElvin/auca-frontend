...
function ManualTimeTable() {
  ...
  const handleDragStart = (e: React.DragEvent, course: any) => {
    ...
    dragPreview.style.backgroundColor = "#f0f9ff"; // Light blue background
  ...
  `;
    ...
    // Set the drag image (adjust offsets to center)
  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 w-full gap-4 lg:col-span-2">
          {scheduledExams.map((date, idx) => {
            ...
            return (
              ...
              >
                {/* Date Header */}
                <div className="text-center py-4 px-3 bg-gray-800 border-b sticky top-0 z-10">
                ...
                <div className="flex-1 overflow-y-auto">
                  <div className="space-y-3 p-3">
                    {date.exams.map((slot, slotIdx) => (
                      <Card
                        key={slotIdx}
                        className="shadow-sm cursor-pointer overflow-hidden relative border-0 mt-0 transition-all duration-200 hover:shadow-md"
                      ...
                      >
                        {/* Time Period Header */}
                        <div className="px-3  bg-blue-300 p-2 text-black">
                          ...
                          {slot.exams ? (
                            <div className="p-3 space-y-2">
                              ...
                              <div className="flex justify-between items-start mb-2">
                                <Badge
                                  variant="outline"
                                  className="hover:bg-inherit text-xs cursor-pointer transition-colors duration-200 px-2 py-1 bg-yellow-300"
                                  onClick={() => {
                                    setMoreExams(
      ...
      {showMore && (
        <div>
          <Draggable handle=".drag-handle" cancel=".no-drag" nodeRef={modalRef}>
            <div
              ref={modalRef}
  ...
  "
              >
                <div className=" bg-gray-800 w-full">
                 <div className="p-2"> <h4 className="font-semibold text-sm ">Scheduled Exams</h4>
                  <p className="text-xs">
                ...
                <Button
                  ...
                  className="ring-offset-background focus:ring-ring  absolute top-5 right-8 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
                >
                  <X className="w-3 h-3" />
                </Button>
              </div>
              ...
              <div className="rounded-md border">
                <div className="p-4">
                  {bestSuggestion ? (
                    <Badge
                      variant="outline"
                      className="w-full p-4 rounded-md flex items-center justify-center font-medium bg-gray-800"
                    >
                      ...
                      {suggestions.map(
                        (suggestion, idx) =>
                          suggestion.suggested && (
                            <div
                              key={idx}
                              onClick={() => setSuggesstedSlot(suggestion)}
                              className={`p-2 text-center m-1 cursor-pointer  border rounded-md ${
