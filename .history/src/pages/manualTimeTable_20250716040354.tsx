            ...
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {availableCourses.map((course) => (
                <div
                  ...
                  className="p-3  rounded-lg border border-gray-200 hover:bg-gray-100 hover:border-blue-300 cursor-move transition-all duration-200"
                >
        ...
        <div className="lg:col-span-2">
          <div className="space-y-6">
            {uniqueDates.map((date) => {
              ...
              return (
                <div key={date} className=" rounded-lg p-6">
                  {/* Date Header */}
                        ...
                        >
                          ...
                          <div
                            ...
                            className={`
                              ...
                              ${assignedCourse 
                                ? '' 
                                : 'border-2 border-dashed border-gray-400 hover:border-blue-400 hover:bg-blue-50'
                              }
                            `}
                          >
                            {assignedCourse ? (
