  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-800 mb-8">Manual Timetable Builder</h1>
          ...
          <div className="lg:col-span-1">
            <div className="rounded-xl shadow-lg p-6 sticky top-6">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-800">Search Courses</h2>
              </div>
              ...
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {availableCourses.map((course) => (
                  <div
                    ...
                    className="p-4 bg-gray-50 rounded-lg border border-gray-200 hover:bg-blue-50 hover:border-blue-300 cursor-move transition-colors duration-200"
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <div className="flex gap-2 mt-2">
                          ...
                          {course.credits && (
                            <span className="text-xs text-green-800 px-2 py-1 rounded">
