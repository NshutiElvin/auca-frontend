...
const OccupanciesPage = () => {
  ...
  const handleDroppedGroup = async (
    ...
    console.log(!draggedCourseGroup || selectedStudents.length <=0)
    if (!draggedCourseGroup || selectedStudents.length <=0) return;
    setServerLoadingMessage({
                      ...
                      <div className="p-6  no-drag cursor-default text-gray-800">
                        <div className="flex items-center">
                          ...
                          <Checkbox
                            ...
                            id="select-all"
                            checked={
                              courseStudents.length === selectedStudents?.length
                            }
