      ...
      {dialogOption?.option == "conflict" && (
        <DialogContent className="sm:max-w-[600px] md:max-w-[800px] lg:max-w-[900px] max-h-[90vh] overflow-hidden flex flex-col">
          <DialogHeader className="text-center space-y-3 pb-4 flex-shrink-0">
            ...
            <DialogDescription className="text-sm text-gray-600 max-w-lg mx-auto leading-relaxed">
              The conflicts that restrain this course from being scheduled on
              this date.
            </DialogDescription>
          </DialogHeader>
                  ...
                  {conflictMessage && conflictMessage.length > 0 ? (
                    conflictMessage.map((conflictedGroup, index) => (
                      <Badge
                        key={index}
                        variant="outline"
                        className="w-full p-3 rounded-md flex justify-between items-center text-left font-medium hover:bg-gray-50 transition-colors"
                      >
          ...
          <DialogFooter className="flex-shrink-0 mt-6 pt-4 border-t bg-gray-50/50">
            <div className="flex items-center justify-between w-full">
