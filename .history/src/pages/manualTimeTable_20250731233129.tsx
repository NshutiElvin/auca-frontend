...
function ManualTimeTable() {
  ...
  const [currentSlotMeta, setCurrentSlotMeta] = useState<any|null>({ day: "", name: "" });
      ...
      {moreExams.length > 0 && showMore && (
        <div>
          <Draggable handle=".drag-handle" cancel=".no-drag" nodeRef={modalRef}>
            ...
            >
              <div className="p-3 border-b flex justify-between items-center drag-handle cursor-move">
                <div>
