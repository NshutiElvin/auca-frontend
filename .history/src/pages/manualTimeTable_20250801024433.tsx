  ...
  "
      ...
      {dialogOption?.option == "conflict" && (
        <DialogContent className="sm:max-w-[600px] md:max-w-[800px] lg:max-w-[900px] max-h-[90vh] overflow-hidden flex flex-col">
          <DialogHeader className="text-center space-y-3 pb-4 flex-shrink-0 bg-gray-800 p-2">
              ...
              <div className="rounded-md border">
                <div className="p-4">
                  {bestSuggestion ? (
                    <Badge
                      variant="outline"
                      className="w-full p-4 rounded-md flex items-center justify-center font-medium bg-yellow-300"
                    >
