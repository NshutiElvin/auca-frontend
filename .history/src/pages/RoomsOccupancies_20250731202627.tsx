...
const OccupanciesPage = () => {
  ...
  const handleDroppedGroup = async (
    ...
    try {
      if (dropAction == "group") {
        ...
        const response = await axios.patch("/api/rooms/verify_room_change/", {
          room: selectedRoom,
  ...
  return (
    ...
    >
     ...
     {dialogMessage&&  <DialogContent className="sm:max-w-[425px] md:max-w-[500px] max-h-[90vh] overflow-y-auto ">
