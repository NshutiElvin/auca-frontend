      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
          ...
          <div className="flex flex-1 space-x-2">
            <div className="flex flex-row justify-around border shadow-md border-foreground">
              {locations &&
                locations.map((loc, idx) => {
                  return (
                    <div className="flex justify-around items-center p-2" key={idx}>
                      <Label className="p-0 m-0">{loc.name}</Label>
