            ...
            <div className="rounded-md shadow-lg p-2 sticky top-2">
              ...
              <ScrollArea className="h-[70vh] rounded-md border p-4 space-y-2 ">
                {allUnscheduled.map((exam) => (
                  <div
                    key={exam.course.id}
                    className="p-3  rounded-lg border border-gray-800 mt-2"
                  >
                    <div
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 w-full gap-4 lg:col-span-2">
          {scheduledExams.map((date, idx) => {
            ...
            return (
              <Card
                key={idx}
                className="shadow-md cursor-pointer overflow-hidden relative flex flex-col border h-full min-h-[400px] mt-0"
              >
                {/* Date Header */}
                <div className="text-center py-4 pt-0 px-3 bg-gray-800 border-b sticky top-0 z-10">
