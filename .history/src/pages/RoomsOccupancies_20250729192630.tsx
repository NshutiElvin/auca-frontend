      ...
      <div className="min-h-screen bg-gray-50">
        ...
        {showModal && (
          <Draggable handle=".drag-handle" cancel=".no-drag" nodeRef={modalRef}>
            <div ref={modalRef} className="bg-white rounded-lg    lg:max-w-[800px]   overflow-auto z-50 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-lg">
