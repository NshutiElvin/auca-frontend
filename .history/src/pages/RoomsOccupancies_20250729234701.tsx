  ...
  const handleDroppedGroup = async (
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setToastMessage({message: "Exam room changed successfully", variant:"success"})
      }
    } catch (error) {
      setToastMessage({message:"Failed to change exam room. Please try again.", variant:"danger"})
      setError("Failed to add occupancy. Please try again.");
    } finally {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="bg-gray-800 hover:bg-blue-600 text-white px-4 py-2 rounded-md flex items-center space-x-2"
          >
                        ...
                        <div    draggable
                                  onDragStart={(e) => {
                                    handleCourseGroupDragStart(e, {
                                      courseId: occupancies[occupancies.length -1].exam_id,
                                      courseCode: occupancies[occupancies.length -1].course_code,
                                      courseTitle: occupancies[occupancies.length -1].course_title,
                                      courseSemester: occupancies[occupancies.length -1].course_semester,
                                      courseDepartment: occupancies[occupancies.length -1].course_department,
                                      courseGroup: occupancies[occupancies.length -1].course_group,
                                      roomName: occupancies[occupancies.length -1].room_name,
                                    });
                                  }}>
                                ...
                                <div
                                  ...
                                  onDragStart={(e) => {
                                    handleCourseGroupDragStart(e, {
                                      ...
                                      courseDepartment: course.course_department,
