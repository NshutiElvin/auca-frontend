                          ...
                          >
                            {assignedCourse ? (
                              <div className="bg-white rounded-lg p-4 shadow-sm border border-blue-200">
                                ...
                                <div className="flex justify-between items-start">
                                  <div className="flex-1">
                                    <h4 className="font-semibold text-gray-800">{slotCourses[slotCourses.length-1].title}</h4>
                                    <p className="text-sm text-gray-600 mt-1">{slotCourses[slotCourses.length-1].department.name}</p>
                                    {assignedCourse.code && (
                                      <span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded mt-2 inline-block">
                                        {slotCourses[slotCourses.length-1].code}
                                      </span>
                                    )}
                                  </div>
                                  <button
