      ...
      <div className="min-h-screen bg-gray-50">
        ...
        {showModal && (
          <Draggable
            ...
            cancel=".no-drag"
            nodeRef={modalRef}
            bounds="parent" // Optional: prevents dragging outside viewport
          >
            {" "}
            <div
              ref={modalRef}
              className="bg-white rounded-lg border border-gray-800 lg:max-w-[800px] max-h-[90vh] overflow-auto z-50 fixed shadow-lg"
              style={{
                top: "50%",
                left: "50%",
