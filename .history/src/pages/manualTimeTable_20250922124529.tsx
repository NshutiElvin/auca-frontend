...
function ManualTimeTable() {
  ...
  useEffect(() => {
    setOpen(false);
    Promise.all([ getUnscheduledExams(),
  getExams()])
  }, []);
        ...
        {isLoadingUnscheduled || isLoadingExams && (
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-2 col-span-2">
                  ...
                  <div className="flex items-center justify-between w-full">
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        If you click "Yes", the exam will be scheduled in the
                        best suggested slot unless you choose a different one
                        above.
                      </p>
                    </div>
