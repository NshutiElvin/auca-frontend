          ...
          <div className=" border-b px-6 py-4">
              ...
              <div className="flex items-center space-x-4 flex-1">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-4 py-2 border  rounded-md text-sm w-64 font-semibold"
                    value={searchTerm}
            ...
            {showFilters && (
              <div className="grid grid-cols-4 gap-4 p-4 rounded-md">
                ...
                <select
                  className="text-sm border  rounded-md px-3 py-2 font-semibold"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div className="text-center space-y-4 p-2 flex items-center justify-between">
                        <h1 className="text-l font-bold leading-tight font-semibold">
                      ...
                      {isGettingStudents ? (
                        ...
                        <div className="p-6  no-drag cursor-default font-semibold">
