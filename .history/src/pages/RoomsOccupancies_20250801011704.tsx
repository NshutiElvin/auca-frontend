                  ...
                  <PanelGroup direction="horizontal">
                    ...
                    >
                      <div className="text-center space-y-4 p-2 flex items-center justify-between">
                        ...
                        <Button
                          className="ring-offset-background focus:ring-ring  absolute top-4 right-10 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
                          variant={"secondary"}
