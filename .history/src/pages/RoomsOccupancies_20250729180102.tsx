...
const BlockedBookings = () => {
  ...
  const filteredData = useMemo(() => {
    return data.filter(occupancy => {
      ...
      const matchesDate =  selectedDate === "" || occupancy.date === selectedDate;

      return matchesSearch && matchesDepartment && matchesSemester && 
             matchesCapacity && matchesOccupancyStatus && matchesDate;
    });
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="border-b border-gray-800 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium text-gray-800">{format( new Date(selectedDate), "PPPP")}</span>
            </div>
            <Button
        ...
        <DialogContent  className="bg-white rounded-lg max-w-4xl w-full mx-4 max-h-[80vh] overflow-hidden">
          <DialogHeader className="text-center space-y-4 pb-2 flex items-center justify-center">
            <DialogTitle className="text-l font-bold  leading-tight">Room Occupancy Details</DialogTitle>
              </DialogHeader>
