...
function ManualTimeTable() {
  ...
  const handleCourseGroupDragStart = (e: React.DragEvent, mygroup: any) => {
    setDraggedCourseGroup({...mygroup, group:mygroup.real_group?mygroup.real_group:mygroup.group});
    console.log(group)
    e.dataTransfer.effectAllowed = "move";
  };
                                              ...
                                              <Badge
                                                ...
                                                onDragStart={(e) =>
                                                  handleCourseGroupDragStart(e, {
                                                    ...
                                                    exam:exam,
                                                    group: exam.real_group,
                                                    course: exam.real_group.course,
                                                    courseId: exam.id,
                                                  })}
                                              >
