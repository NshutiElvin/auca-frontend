          ...
          <div className=" border-b px-6 py-4">
              ...
              <div className="flex items-center space-x-4 flex-1">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-4 py-2 border  rounded-md text-sm w-64 text-gray-800"
                    value={searchTerm}
            ...
            {showFilters && (
              <div className="grid grid-cols-4 gap-4 p-4 rounded-md">
                ...
                <select
                  className="text-sm border  rounded-md px-3 py-2 text-gray-800"
          ...
          <div className="p-6">
            <div className="rounded-lg border  overflow-hidden">
              <div className="flex border-b ">
                <div className="w-20 p-3 bg-gray-50 font-medium text-sm text-gray-900 border-r ">
                  Rooms
                </div>
                {timeSlots.map((time, index) => (
                  <div
                    key={index}
                    className="flex-1 p-3 bg-gray-50 text-center text-sm font-medium text-gray-900 border-r  last:border-r-0"
                  >
                    {formatTime(time)}
                  </div>
                ))}
              ...
              <div className="divide-y divide-gray-800 max-h-[600px] overflow-y-auto">
                {rooms.map((room) => (
                  <div key={room} className="flex">
                    <div className="w-20 p-3 bg-gray-50 flex items-center justify-center border-r ">
                      <div className="flex items-center space-x-2">
                            ...
                            <div className="grid gap-3 ">
                              {slot.courses.map(
                                (course: any, courseIndex: number) => (
                                  <div
                                    key={courseIndex}
                                    className="p-3 bg-gray-50 rounded-sm border  cursor-grabbing"
                                    draggable
                                    onDragStart={(e) => {
                                      handleCourseGroupDragStart(e, {
                                  ...
                                  >
                                    <div className="flex items-center justify-between hover:opacity-50"    onClick={() => {
          ...
          {showStudentModal && (
            <div>
              ...
              >
                <div
                  ref={studentModalRef}
                  className="bg-white rounded-lg  z-50 relative shadow-lg w-fit "
                  style={{
                    position: "fixed",
                    maxHeight: "80vh",
                    top: "10%",
                    ...
                    >
                      ...
                      {isGettingStudents ? (
                        ...
                        <div className="p-6  no-drag cursor-default text-gray-800">
                          ...
                          <div
                            className=" overflow-y-scroll max-h-[50vh]"
                            
                          >
                            {courseStudents.map((student, index) => (
                              <div
                                key={index}
                                className="p-3 bg-gray-50 rounded-sm border  cursor-grabbing mt-2"
                                draggable
                                onDragStart={(e) =>
