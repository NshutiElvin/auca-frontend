          ...
          <div className="p-6">
            <div className="rounded-lg border  overflow-hidden">
              <div className="flex border-b ">
                <div className="w-20 p-3 bg-gray-50 font-medium text-sm  border-r ">
                  Rooms
                </div>
                {timeSlots.map((time, index) => (
                  <div
                    key={index}
                    className="flex-1 p-3 bg-gray-50 text-center text-sm font-medium  border-r  last:border-r-0"
                  >
                    {formatTime(time)}
                  </div>
                ))}
