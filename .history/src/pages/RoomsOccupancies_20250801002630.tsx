              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    />
                    <PanelResizeHandle className="w-1 bg-gray-200 hover:bg-gray-800 transition-colors" />

                    <Panel
                      defaultSize={60}
                      minSize={30}
                      order={2}
                      className="drag-handle  border-b border-gray-200 cursor-move"
                    >
                      <div className="text-center space-y-4 p-2 flex items-center justify-between">
                        ...
                        <button className="px-4 py-2 text-sm font-medium  bg-gray-100  rounded-md">
                      ...
                      <div className="flex items-center justify-end space-x-3 p-6 border-t ">
                        <button
                          ...
                          className="px-4 py-2 text-sm font-medium text-gray-700  hover:bg-gray-800 rounded-md"
                        >
                          Close
                        </button>
                      </div>
