  ...
  const handleDroppedCourse = async (e: React.DragEvent, slotInfo: any) => {
    ...
    if (draggedCourseGroup) {
      try {
        ...
        console.log(resp.data.best_suggestion)
        console.log(resp.data.all_suggestions)
                                      ...
                                      >
                                        <ScrollArea className="h-[50vh] rounded-md border p-4">
                                          {moreExams.length > 0 ? (
                                            ...
                                            <div key={idx} className="flex justify-between align-middle  space-x-1 flex-row-reverse">
                                                <Badge
                                                variant={"outline"}
