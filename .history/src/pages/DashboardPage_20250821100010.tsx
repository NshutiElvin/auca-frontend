   ...
   const handleCardClick = async (cardType:any) => {
    ...
    try {
      ...
      const endpointMap:any = {
        'today-exams': '/api/schedules/dashboard/today-exams/',
        'ongoing-exams': '/api/schedules/dashboard/ongoing-exams/',
        'completed-exams': '/api/schedules/dashboard/completed-exams/',
        'scheduled-exams': '/api/schedules/dashboard/scheduled-exams/',
        'popular-exams': '/api/schedules/dashboard/popular-exams/',
        'today-students': '/api/schedules/dashboard/today-students/'
      };
