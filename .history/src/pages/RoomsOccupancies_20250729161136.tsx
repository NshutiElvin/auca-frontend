          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <button className="flex items-center space-x-2 px-3 py-1 bg-gray-100 rounded-md text-sm text-gray-700 hover:bg-gray-800">
                  <Filter className="w-4 h-4" />
                  <span>Filters</span>
                </button>
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg p-3 z-10 border border-gray-800">
              ...
              <div className="bg-blue-500  px-3 py-1 rounded-md text-sm flex items-center space-x-1">
          ...
          <div className="p-6">
            <div className="bg-white rounded-lg border border-gray-800 overflow-hidden">
              ...
              <div className="flex border-b border-gray-800">
                <div className="w-16 p-3   font-medium text-sm text-gray-900 border-r border-gray-800">
                  Rooms
                </div>
                {timeSlots.map((time, index) => (
                  <div
                    key={index}
                    className="flex-1 p-3   text-center text-sm font-medium text-gray-900 border-r border-gray-800 last:border-r-0"
                  >
                    {time}
                  </div>
                ))}
              ...
              <div className="divide-y divide-gray-800">
                {uniqueRooms.map((room) => (
                  <div key={room} className="flex">
                    <div className="w-16 p-3   flex items-center justify-center border-r border-gray-800">
                      <div className="flex items-center space-x-2">
                    ...
                    {timeSlots.map((time, timeIndex) => {
                      ...
                      return (
                        <div
                          key={timeIndex}
                          className="flex-1 p-2 border-r border-gray-800 last:border-r-0 min-h-[64px]"
                        >
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="mt-6 flex justify-end">
                <button
                  onClick={handleCloseModal}
                  className="px-4 py-2 bg-blue-600  text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
                  Close
                </button>
              </div>
