          ...
          <div className="flex justify-start">
            ...
            >
              ...
              {unscheduledExams.length > 0 && (
                <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-primary text-black text-xs  font-medium p-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 w-full gap-4 lg:col-span-2">
              {scheduledExams.map((date, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="text-center py-2 px-2 bg-gray-800 border-b sticky top-0 z-10 text-white">
                              ...
                              {slot.exams ? (
                                <div className="p-3 space-y-2 w-full">
                                  <div className="flex justify-between items-start mb-2">
                                    <Badge
                                      variant="outline"
                                      className="hover:bg-inherit text-xs cursor-pointer transition-colors duration-200 px-2 py-1 bg-primary text-black"
                                      onClick={() => {
                                        setMoreExams(
                  ...
                  <div className="rounded-md border">
                    <div className="p-4">
                      {bestSuggestion ? (
                        <Badge
                          variant="outline"
                          className="w-full p-4 rounded-md flex items-center justify-center  bg-primary text-black font-bold"
                        >
