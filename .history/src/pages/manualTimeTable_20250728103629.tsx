                  ...
                  {slot.exams ? (
                    <div className="p-3 space-y-2">
                      ...
                      <div className="flex justify-between items-start mb-2">
                        <Badge
                          variant="outline"
                          className="hover:bg-gray-100 text-xs cursor-pointer transition-colors duration-200 px-2 py-1"
                          onClick={() => {
                            setMoreExams(
                        ...
                        >
                          +{slot.exams.length > 0 ? slot.exams.length - 1 : 0}
                        </Badge>
                        ...
                        {slot.exams[slot.exams.length - 1] && (
                          <Popover>
                            <PopoverTrigger asChild>
                              <Badge
                                variant="outline"
                                className="w-full p-2 text-left cursor-pointer hover:bg-gray-50 transition-colors duration-200 justify-start min-h-[36px] text-wrap break-words"
                                onClick={() => {
                                  setMoreExams(
                                    slot.exams.map((e: any) => ({
                                      ...e,
                            ...
                            >
                              <div className="p-3 border-b bg-gray-50">
                                ...
                                <p className="text-xs text-gray-500">
                                  {slot.name} • {format(dateObj, "eee, dd MMM")}
                                </p>
                              </div>
                                ...
                                <div className="p-3 space-y-2">
                                  {moreExams.length > 0 ? (
                                    moreExams.map((exam, examIdx) => (
                                      <div
                                        key={examIdx}
                                        className="flex items-center gap-2 p-2 rounded-md hover:bg-gray-50 transition-colors duration-200"
                                      >
                                        <Badge
                                          variant="outline"
