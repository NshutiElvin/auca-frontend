          ...
          <div className="p-6">
            <div className="rounded-lg border  overflow-hidden">
              <div className="flex border-b ">
                <div className="w-20 p-3  font-medium text-sm  border- flex-1 ">
                  Rooms
                </div>
                {timeSlots.map((time, index) => (
                  <div
                    key={index}
                    className="flex-1 p-3  text-center text-sm font-medium  border-r  last:border-r- flex-2"
                  >
                    {formatTime(time)}
                  </div>
                ))}
              ...
              <div className="divide-y divide-gray-800 max-h-[600px] overflow-y-auto min-w-full">
                {rooms.map((room) => (
                  <div key={room} className="flex">
                    <div className="w-20 p-3  flex-1 items-center justify-center border-r ">
                      <Button className="flex items-center space-x-2 flex-1 min-w-fit">
                      ...
                      {isGettingStudents ? (
                        ...
                        <div className="p-6  no-drag cursor-default font-bold">
                          <div className="flex items-center">
                            ...
                            />{" "}
                            <Label htmlFor="select-all" className="text-foreground">Select All</Label>
                          </div>
