            ...
            <div className="rounded-xl shadow-lg p-6 sticky top-6">
              ...
              <div className="relative mb-6">
                ...
                <input
                  ...
                  className="border w-full pl-4 pr-4 py-2  rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {availableCourses.map((course) => (
                  <div
                    ...
                    className="p-2 rounded-md border   hover:bg-blue-50 hover:border-blue-300 cursor-move transition-colors duration-200"
                  >
