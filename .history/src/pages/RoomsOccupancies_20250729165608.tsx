        ...
        <div className="p-6">
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div className="flex border-b border-gray-200">
              <div className="w-20 p-3 bg-gray-50 font-medium text-sm text-gray-900 border-r border-gray-200">
                Rooms
              </div>
              {timeSlots.map((time, index) => (
                <div
            ...
            <div className="divide-y divide-gray-200 max-h-[600px] overflow-y-auto">
              {rooms.map((room) => (
                <div key={room} className="flex">
                  <div className="w-20 p-3 bg-gray-50 flex items-center justify-center border-r border-gray-200">
                    <div className="flex items-center space-x-2">
                      <div className="w-4 h-3 bg-gray-400 rounded-sm"></div>
                      <span className="text-sm font-medium text-gray-900">
                        {room}
                  ...
                  {timeSlots.map((_, timeIndex) => {
                    ...
                    return (
                      <div
                        key={timeIndex}
                        className="flex-1 p-2 border-r border-gray-200 last:border-r-0 min-h-[80px]"
                      >
                        {occupancies.length > 0 && (
                          <OccupancyCard occupancies={occupancies} />
                        )}
