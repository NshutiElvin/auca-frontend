                ...
                <div className="h-64 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie
                        data={[
                          { name: "Completed", value: dashboardData.completed_percentage, fill: "#10b981" },
                          { name: "Ongoing", value: dashboardData.ongoing_percentage, fill: "#3b82f6" },
                          { name: "Scheduled", value: dashboardData.scheduled_percentage, fill: "#f59e0b" },
                          { name: "Cancelled", value: dashboardData.cancelled_percentage, fill: "#6b7280" },
                        ]}
                        cx="50%"
                        cy="50%"
                        innerRadius={60}
