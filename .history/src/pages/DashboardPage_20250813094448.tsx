...
const DashboardPage = () => {
  ...
  const getDashboard = () => {
    startGettingDashboardTransition(async () => {
      try {
        const response = await axios.post("/api/schedules/dashboard/");
...
const stats = [
  ...
  return isGettingDashboard?<div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 flex items-center justify-center">
            ...
            <Card className="border-0 shadow-sm bg-white dark:bg-gray-800">
              <CardHeader>
                ...
                <CardDescription className="text-gray-600 dark:text-gray-400">
                  Monthly exam completion rates and scores
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart
                      data={[
                        { month: "Jan", completed: 65, average: 78 },
                        { month: "Feb", completed: 72, average: 82 },
                        { month: "Mar", completed: 86, average: 85 },
                        { month: "Apr", completed: 89, average: 88 },
                        { month: "May", completed: 92, average: 90 },
                      ]}
                    >
                      <CartesianGrid
                        strokeDasharray="3 3"
                    ...
                    <PieChart>
                      <Pie
                        data={[
                          ...
                          { name: "Running", value: 10, fill: "#3b82f6" },
                          { name: "Scheduled", value: 8, fill: "#f59e0b" },
                          { name: "Draft", value: 5, fill: "#6b7280" },
                        ]}
                        cx="50%"
                        cy="50%"
                        innerRadius={60}
              ...
              <CardContent>
                <div className="h-64 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart
                      data={[
                        { range: "0-40", students: 15, fill: "#ef4444" },
                        { range: "41-60", students: 45, fill: "#f59e0b" },
                        { range: "61-80", students: 128, fill: "#3b82f6" },
                        { range: "81-100", students: 244, fill: "#10b981" },
                      ]}
                    >
                      <CartesianGrid
                        strokeDasharray="3 3"
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart
                      data={[
                        ...
                        { day: "Wed", submissions: 68 },
                        { day: "Thu", submissions: 72 },
                        { day: "Fri", submissions: 85 },
