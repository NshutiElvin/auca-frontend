  ...
  const handleGettingStudents =()=>{
    ...
    startGettingStudentsTransition(async() => {
      setServerLoadingMessage({
        message: `Fetching students for ${draggedCourseGroup.courseCode}`,
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {isGettingStudents ? (
                      <div className="flex items-center justify-center p-6"> </div>):<>Getting students</>}
                  </Panel>
                  <PanelResizeHandle className="w-2 bg-gray-200 hover:bg-gray-800 transition-colors" />
