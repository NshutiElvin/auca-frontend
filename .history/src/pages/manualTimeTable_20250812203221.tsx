      ...
      resp.data.data.map((ex: any) => {
        ...
        if (existingDay !== undefined) {
          ...
          let newDay: DailyExam = {
            ...
            exams: [
              { name: "Morning",start:"", end:"", exams: [] },
              { name: "Afternoon",start:"", end:"", exams: [] },
              { name: "Evening",start:"", end:"", exams: [] },
            ],
          };
          if (ex.slot_name == "Morning") {
            newDay.exams[0].exams.push(ex);
            newDay.exams[0].start=ex.start
            newDay.exams[0].end=ex.end
          } else if (ex.slot_name == "Afternoon") {
            newDay.exams[1].exams.push(ex);
            newDay.exams[1].start=ex.start
            newDay.exams[1].end=ex.end
          } else if (ex.slot_name == "Evening") {
            newDay.exams[2].exams.push(ex);
            newDay.exams[2].start=ex.start
            newDay.exams[2].end=ex.end
          }
