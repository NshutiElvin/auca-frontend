          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <button className="flex items-center space-x-2 px-3 py-1 bg-gray-100 rounded-md text-sm text-gray-700 hover:bg-gray-00">
                  <Filter className="w-4 h-4" />
                  <span>Filters</span>
                </button>
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg p-3 z-10 border border-gray-00">
                  <div className="space-y-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full text-sm border border-gray-800 rounded-md px-2 py-1"
                      >
