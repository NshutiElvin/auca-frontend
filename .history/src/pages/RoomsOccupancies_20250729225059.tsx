...
interface DraggedCourseGroup {
  ...
  courseGroup?: string;
  roomName?: string; // Optional, if dragging to a room
}
const OccupanciesPage = () => {
  ...
  const handleDroppedGroup = async (
    ...
    try {
      const response = await axios.post("/api/rooms/occupancies/", {
        room_name: selectedRoom.roomName,
        date: selectedRoom.date,
        start_time: selectedRoom.startTime,
        end_time: selectedRoom.endTime,
        course_code: draggedCourseGroup.courseCode,
        course_title: draggedCourseGroup.courseTitle,
        course_semester: draggedCourseGroup.courseSemester,
        course_department: draggedCourseGroup.courseDepartment,
        course_group: draggedCourseGroup.courseGroup,
      });
