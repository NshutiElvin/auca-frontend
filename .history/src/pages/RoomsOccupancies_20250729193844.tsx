      ...
      <div className="min-h-screen bg-gray-50">
        ...
        {showModal && (
          <Draggable handle=".drag-handle" cancel=".no-drag" nodeRef={modalRef}>
            ...
            <div
      ref={modalRef}
      className="bg-white rounded-lg border border-gray-800 lg:max-w-[800px] overflow-auto z-50 fixed top-1/2 left-1/2 shadow-lg"
      style={{ cursor: 'move' }}
      
    >
          <div className="drag-handle p-4 border-b border-gray-800 cursor-move bg-gray-50">
