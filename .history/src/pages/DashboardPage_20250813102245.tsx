...
const DashboardPage = () => {
  ...
  const barChartData =
    ...
    const areaChartData = dashboardData.weekly_exams_by_day?.map((dayData:any) => ({
  day: dayData.day,
  submissions: dayData.exams.reduce((total:number, exam:any) => total + exam.student_count, 0)
})) || [];
  const stats = [
    {
