  ...
  return (
    ...
    <Draggable handle=".drag-handle" cancel=".no-drag" nodeRef={modalRef}>
      <div
        ...
        style={{
          // Remove conflicting transforms, let Draggable handle positioning
          width: 'fit-content',
          maxHeight: '80vh'
        }}
      >
        {/* ADD THIS: Drag handle header */}
        <div className="drag-handle bg-gray-50 px-6 py-4 border-b border-gray-200 cursor-move flex items-center justify-between">
                ...
                <div className="p-6 overflow-y-auto w-fit">
                      ...
                      {slot.total_students > slot.room_capacity && (
                        <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-md">
                          ...
                          <p className="text-sm text-red-600 mt-1">
                            ...
                            Consider moving some exams to larger rooms or
                    ...
                    onClick={() => {
                      const modalData = groupedOccupancies.map((slot) => ({
                        ...
                        courses: slot.courses
                          .map(
                            (c: any) => `${c.course_code} (${c.student_count})`
                          )
                          .join(", "),
                      }));
