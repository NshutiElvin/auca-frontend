            ...
            <div className="flex flex-row justify-around border shadow-md border-foreground rounded-md">
              {locations &&
                locations.map((loc, idx) => {
                  return (
                    <div
                      className="flex justify-around items-center p-2 space-x-1 cursor-pointer"
                      key={idx}
                    >
                      <Checkbox
                        className="p-0 m-0 border border-foreground"
                        id={loc.id.toString()}
                      ...
                      />
                      <Label className="p-0 m-0 cursor-pointer" htmlFor={loc.id.toString()}>
                        {loc.name}
                      </Label>
                    </div>
                  );
