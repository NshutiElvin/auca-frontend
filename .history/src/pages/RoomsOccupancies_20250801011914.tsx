          ...
          {showModal && (
            <div>
              ...
              >
                <div
                  ref={modalRef}
                  className={`bg-background border animate-in border-gray-800 shadow-gray-800 rounded-lg  z-50 relative shadow-lg w-fit hover:z-[55] ${
                    showModal&& "animate-out fade-out-0 zoom-out-95"
