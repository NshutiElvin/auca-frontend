...
import { Bell, BellIcon, LogOut, Settings, User, User2Icon } from "lucide-react";
          ...
          <div className="gap-4">
            <Popover>
              <PopoverTrigger asChild>
                 <Button
                    className="relative inline-flex items-center justify-center w-10 h-10 rounded-full border border-gray-300 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
                    aria-label="Notifications"
                    onClick={markAllAsRead}
                  >
                    <Bell className="h-4 w-4 text-gray-600" />
                    {unreadCount > 0 && (
                      <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-xs text-white font-medium p-1">
