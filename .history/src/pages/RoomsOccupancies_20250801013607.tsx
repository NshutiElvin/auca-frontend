          ...
          {showModal && (
            <div>
              ...
              >
                <div
                  ref={modalRef}
                  className={`bg-background border p-2 animate-in border-gray-800 shadow-gray-800 z-50 relative  w-fit hover:z-[55] rounded-lg shadow-lg duration-200`}
                  style={{
                    position: "fixed",
                    maxHeight: "80vh",
                    top: "25%",
                ...
                >
                  <PanelGroup direction="horizontal">
                    ...
                    >
                      ...
                      <div className="text-center space-y-4 p-2 flex items-center justify-  bg-gray-800 w-full">
          ...
          {showStudentModal && (
            <div>
              ...
              >
                <div
                  ref={studentModalRef}
                                   className={`bg-background border animate-in border-gray-800 shadow-gray-800 z-50 relative  w-fit hover:z-[55] rounded-lg shadow-lg duration-200`}
                  style={{
                    position: "fixed",
                    maxHeight: "80vh",
                    top: "10%",
