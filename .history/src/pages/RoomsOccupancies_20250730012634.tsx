                ...
                >
                  ...
                  >
                    <div className="text-center space-y-4 p-2 flex items-center justify-between">
                      ...
                      <Button className="no-drag" variant="ghost">
                        <X className="w-4 h-4" onClick={()=>setShowModal(false)} />
                      </Button>
                    </div>
                ...
                >
                  ...
                  >
                    <div className="text-center space-y-4 p-2 flex items-center justify-between">
                      ...
                      <Button>
                        <X className="w-4 h-4" onClick={()=>setShowStudentModal(false)} />
                      </Button>
                    </div>
                    {isGettingStudents ? (
                      ...
                      <div className="p-6 overflow-y-auto w-fit no-drag cursor-default text-gray-800">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="flex items-center space-x-4 mt-1 text-sm text-gray-500">
                                  ...
                                  {student.exam.group.course.semester && (
                                    <span>
                                      Semester: {student.exam.group.course.semester.name}
                                    </span>
                                  )}
                                  {student.exam.group && (
                                    <span>Group: {student.exam.group.group_name}</span>
                                  )}
                                </div>
                              </div>
                              <div className="flex items-center space-x-2">
