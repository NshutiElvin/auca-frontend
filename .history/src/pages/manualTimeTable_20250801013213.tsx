  ...
  "
              >
                <div className="p-2 bg-gray-800 w-full">
                  <h4 className="font-semibold text-sm ">Scheduled Exams</h4>
                  <p className="text-xs">
                ...
                <Button
                  ...
                  className="ring-offset-background focus:ring-ring  absolute top-4 right-8 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
                >
                  <X className="w-3 h-3" />
                </Button>
              </div>
