...
interface DialogOption {
  option: "more" | "conflict" | "group-conflict" | "conflicted-students";
}
...
function ManualTimeTable() {
        ...
        >
          ...
          <div>
            ...
            >
              <div
                ref={modalRef}
                className={`bg-background rounded-lg  z-7000 relative shadow-md w-[500px] hover:z-[55] shadow-gray-800  ${
                  serverLoadingMessage?.isServerLoading &&
  ...
  "
                  ...
                  <div className=" bg-gray-800 w-full text-white">
                    <div className="p-2">
                      ...
                      <h4 className="font-semibold text-sm ">
                        ...
                        {conflictedCOurses.length>1&& <div>{conflictedCOurses[0]} VS {conflictedCOurses[1]}</div>}
                    </div>
                  </div>
                  <Button
                    variant="ghost"
              ...
              {
              conflictedStudents.map((student:any, idx)=>{
                return <div key={idx}>{JSON.stringify(student)}</div>
              })
            }
  ...
  "
        ...
        {dialogOption?.option == "conflict" && (
          <DialogContent className="sm:max-w-[600px] md:max-w-[800px] lg:max-w-[900px] max-h-[90vh] flex-col">
                      ...
                      conflictMessage.map((conflictedGroup, index) => (
                        <Badge
                          ...
                          onClick={()=>{
                            ...
                            setConflictedCourses([conflictedGroup[0].course.title, conflictedGroup[1].course.title])
            ...
            <DialogFooter className="flex-shrink-0 mt-6 p-4 border-t bg-gray-800 absolute bottom-2">
