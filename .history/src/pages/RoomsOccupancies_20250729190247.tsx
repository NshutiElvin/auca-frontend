  ...
  return (
    <div>
      <div className="min-h-screen bg-gray-50">
        ...
        {showModal && (
          <div className="bg-white rounded-lg    lg:max-w-[800px] h-[90vh] overflow-auto z-50 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-lg">
                  ...
                  {slot.total_students > slot.room_capacity && (
                    <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-md">
                      ...
                      <p className="text-sm text-red-600 mt-1">
                        ...
                        {slot.total_students - slot.room_capacity} students.
                        Consider moving some exams to larger rooms or different
                        time slots.
                      </p>
                    </div>
                  )}
                ...
                onClick={() => {
                  const modalData = groupedOccupancies.map((slot) => ({
                    ...
                    courses: slot.courses
                      .map((c: any) => `${c.course_code} (${c.student_count})`)
                      .join(", "),
                  }));
