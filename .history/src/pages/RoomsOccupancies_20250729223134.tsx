...
const OccupanciesPage = () => {
  ...
  const [selectedRoom, setSelectedRoom] = useState<SelectedRoom | null>(null);
    const [draggedCourseGroup, setDraggedCourseGroup] = useState<DraggedCourseGroup | null>(null);
  ...
  const handleDroppedGroup = async (e: React.DragEvent, selectedRoom: SelectedRoom) => {
    e.preventDefault();
  setSelectedRoom(selectedRoom)
  };


    const handleCourseGroupDragStart = (e: React.DragEvent, group: DraggedCourseGroup) => {
                  ...
                  {timeSlots.map((_, timeIndex) => {
                    ...
                    return (
                      <div
                        ...
                        onDrop={(e) => {
                          handleDroppedGroup(e, {roomName:room, date: selectedDate, startTime: timeSlots[timeIndex], endTime: timeSlots[timeIndex] });
                        }}
