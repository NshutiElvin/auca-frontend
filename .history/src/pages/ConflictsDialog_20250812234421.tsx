...
export function ConflictDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[810px] bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 p-5">
        <DialogHeader>
        ...
        <div className="relative mb-4">
          ...
          <Input
            ...
            className="pl-10 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-blue-500 dark:focus:ring-blue-400"
          />
          {searchTerm && (
            <button
