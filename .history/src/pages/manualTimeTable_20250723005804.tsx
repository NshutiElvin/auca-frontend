                                      ...
                                      >
                                        <ScrollArea className="h-[50vh] rounded-md border p-4">
                                          {moreExams.length > 0 ? (
                                            ...
                                            <div key={idx} className="flex justify-between align-middle">
                                                <Badge
                                                variant={"outline"}
                                                className="w-full p-2 m-1  rounded flex-grow overflow-hidden font-medium flex-0.8"
                                                draggable
                                                onDragStart={(e) =>
                                              ...
                                              variant={"outline"}
                                              className="text-gray-500 hover:text-gray-400  p-1 rounded hover:bg-red-50 flex-0.1"
                                            >
                                              <X className="w-4 h-4" />
                                            </Button>
                                            </div>
