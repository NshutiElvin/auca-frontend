...
import { StudentSchedulerProvider } from "../../providers/student-scheduler-provider";
...
function StudentExamsPage() {
  ...
  return (
    ...
    <div>
      ...
      {activeView == "grid" && (
        <StudentSchedulerProvider weekStartsOn="monday" initialState={exams}>
