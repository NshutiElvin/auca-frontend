        ...
        <DialogContent className="sm:max-w-[600px] md:max-w-[800px] lg:max-w-[900px] max-h-[90vh] overflow-hidden flex flex-col">
          <DialogHeader className="text-center space-y-3 pb-4 flex-shrink-0">
            <DialogTitle className="text-xl font-bold leading-tight">
              The conflicts found for {draggedCourse?.course?.title || draggedCourseGroup&& draggedCourseGroup.course.title} 
               {draggedCourse?.course?.group?.group_name|| draggedCourseGroup&& draggedCourseGroup.course.group.group_name} 
               for {selectedSlotInfo?.slot?.name} on {selectedSlotInfo?.day&&format(new Date(selectedSlotInfo?.day), "dd MMM yyyy")}
            </DialogTitle>
