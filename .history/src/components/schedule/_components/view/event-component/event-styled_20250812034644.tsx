...
export default function EventStyled({
  ...
  function handleEditEvent(event: Event) {
    ...
    setOpen(
      user.role=="student"?<CustomModal title={``} >
  ...
  return (
    <div
      key={event?.id}
      className={cn(
        "w-full z-50 relative cursor-pointer border group rounded-lg flex m-2 flex-col flex-grow shadow-sm hover:shadow-md transition-shadow duration-200",
