...
export default function SchedulerViewFilteration({
  ...
  const { setExams, unScheduled, setStatus, status } = useExamsSchedule();
              ...
              {CustomComponents?.customButtons?.CustomAddEventButton ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex rounded-full border overflow-hidden">
                    ...
                    <Button
                      className="flex items-center space-x-2 px-3 py-1 bg-green-950 hover:bg-green-800 text-sm rounded-none last:rounded-r-full"
                      variant="outline"
                    >
