...
export default function SchedulerViewFilteration({
  ...
  const [dialogType, setShowDialogType] = useState<"configuration"|"confirmation"|null>(null);
  ...
  return (
    <Dialog open={showDialog} onOpenChange={()=>{
                ...
                {CustomComponents?.customButtons?.CustomAddEventButton ? (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex rounded-full border overflow-hidden">
                      <Button
                        onClick={() =>  setShowDialogType("configuration")}
                    ...
                    <Link to={"/admin/timetables"} className="text-blue-400 underline" >More Timetables</Link>
                  </div>
                )}
              </div>
      ...
      {dialogType=="configuration" &&      <DialogContent className="sm:max-w-[425px] md:max-w-[500px] max-h-[90vh] overflow-y-auto ">
      ...
      {dialogType=="confirmation"&&       <DialogContent className="sm:max-w-[425px] md:max-w-[500px] max-h-[90vh] overflow-y-auto ">
        <DialogHeader className="text-center space-y-4 pb-2 flex items-center justify-center">
          <DialogTitle className="text-l font-bold  leading-tight">
            Confirm Delete
          </DialogTitle>
        ...
        <div className="relative p-4">
          This will only delete students exams records from database, for saving space and preventing conflict for the future exams that will be generated.
        </div>
