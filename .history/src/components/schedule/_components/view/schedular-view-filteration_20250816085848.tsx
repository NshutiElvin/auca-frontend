      ...
      {dialogType == "configuration" && (
        <DialogContent className="sm:max-w-[425px] md:max-w-[500px] max-h-[90vh] overflow-y-auto ">
          ...
          <div className="flex flex-col gap-2 p-2">
            ...
            <Input type="text" id="academic_year" className="col-span-3" onChange={(e)=>{
              setConfiguration({
                 ...configuration,
          ...
          <div className="grid grid-cols-1 items-center gap-4">
            ...
            <select id="term" className="col-span-3 p-2 rounded-md bg-background border" onChange={(e)=>{
              setConfiguration({
                ...configuration,
                term:e.target.value
              })
              ...
              {defaultConfigurations.semesters.map((semester:any, index)=>{
                return <option value={semester?.name} key={index}> {semester.name}</option>
              })}
            </select>
          </div>
          ...
          <div className="grid grid-cols-1 items-center gap-4">
            ...
            <select  id="location" className="col-span-3 p-2 rounded-md bg-background border" onChange={(e)=>{
              setConfiguration({
                ...configuration,
              ...
              {defaultConfigurations.locations.map((location:any, index)=>{
                return <option value={location.name} key={index}>
                  {location.name}
          ...
          <DialogFooter>
            <Button variant={"default"} onClick={() => {
              if (configuration.academicYear.trim().length<4|| configuration.location.trim().length<=0|| configuration.location.trim().length<3){
                setToastMessage({
                  message:"please complete this form before proceed",
                  variant:"danger"
                })
                return
              }
            ...
            }} disabled={configuration.academicYear.trim().length<4|| configuration.location.trim().length<=0|| configuration.location.trim().length<3}>
              Continue
            </Button>{" "}
      ...
      {dialogType == "confirmation" && (
        <DialogContent className="sm:max-w-[425px] md:max-w-[500px] max-h-[90vh] overflow-y-auto ">
          <DialogHeader className="text-center space-y-4 pb-2 flex items-center justify-center">
            ...
            <DialogDescription className="text-sm  max-w-md mx-auto leading-relaxed  text-center">
              Do you realy want to do this actions?
            </DialogDescription>
          </DialogHeader>
