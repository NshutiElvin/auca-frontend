        ...
        <DialogContent className="sm:max-w-[425px] md:max-w-[500px] max-h-[90vh] overflow-y-auto ">
          <DialogHeader className="text-center space-y-4 pb-2 flex items-center justify-center">
            ...
            <div className="relative">
              This will only delete students exams records from database.
              </div>

        <DialogFooter>
          <Button variant={"default"} onClick={()=>deleteAllTimeTables()}>Yes</Button> <Button variant={"secondary"} onClick={()=>setShowDialog(false)}>No</Button>
        </DialogFooter>
        </DialogContent>
    </Dialog>
  );
