...
import { Calendar as CalendarIcon, CalendarDaysIcon, TrashIcon, Loader, PrinterCheckIcon } from "lucide-react";
...
export default function SchedulerViewFilteration({
  ...
  const handleViewChange = (newView: string) => {
    ...
    const { setServerLoadingMessage, serverLoadingMessage } =
    useToast();
