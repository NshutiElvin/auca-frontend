...
<div className="flex items-center gap-2">
  {/* Button Group */}
  <div className="flex bg-gray-100 rounded-full border overflow-hidden">
    <button
      onClick={() => {
        handleAddEvent();
      }}
  ...
  <button
    ...
    className="flex items-center px-3 py-2 bg-red-100 hover:bg-red-200 text-red-600 rounded-md text-sm"
  >
