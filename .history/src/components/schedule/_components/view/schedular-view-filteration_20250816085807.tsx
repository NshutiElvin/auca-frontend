      ...
      {dialogType == "configuration" && (
        <DialogContent className="sm:max-w-[425px] md:max-w-[500px] max-h-[90vh] overflow-y-auto ">
          ...
          <div className="grid grid-cols-1 items-center gap-4">
            ...
            <select id="term" className="col-span-3 p-2 rounded-md bg-background" onChange={(e)=>{
              setConfiguration({
                ...configuration,
                term:e.target.value
              })
          ...
          <div className="grid grid-cols-1 items-center gap-4">
            ...
            <select  id="location" className="col-span-3 p-2 rounded-md bg-background" onChange={(e)=>{
              setConfiguration({
                ...configuration,
