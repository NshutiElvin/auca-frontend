  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex justify-center gap-1 items-center border w-fit rounded-sm p-2 shadow-md">
        <Button variant={windowView.formOnly? "default":"secondary"}>Form Only</Button>
        <Button variant={windowView.split? "default":"secondary"}>Split</Button>
        <Button variant={windowView.slotsOnly? "default":"secondary"}>Slots Only</Button>
      </div>
