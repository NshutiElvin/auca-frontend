    ...
    <div className="flex flex-col items-center  justify-start">
      ...
      >
        {(windowView.split || windowView.formOnly) && (
          <form
            className={`flex flex-col gap-4 p-2 pt-0 sm:max-w-[800px] max-h-[100vh] overflow-y-auto`}
        ...
        {(windowView.split || windowView.slotsOnly) && (
            <div className={`${windowView.slotsOnly?"min-w-full":""}`}>
              <div className="text-center py-2 px-3 text-2xl font-bold">
                Examination Slots
              </div>
              {examSlots ? (
                <div className={`${windowView.slotsOnly?"grid grid-cols-5 min-w-full":"grid grid-cols-3"} gap-2 max-h-[70vh] overflow-y-scroll`}>
