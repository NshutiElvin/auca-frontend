...
import { CalendarIcon, Loader, Loader2, Pencil, Printer, X } from "lucide-react";
        ...
        {(windowView.split || windowView.formOnly) && (
          <form
            className={`flex flex-col gap-4 p-2 pt-0 ${
              windowView.formOnly ? "w-full max-w-[1200px]" : "sm:max-w-[800px]"
              ...
              <div
                className={`${
                  windowView.slotsOnly
                    ...
                    : "grid grid-cols-3"
                } gap-2 max-h-[70vh] overflow-y-scroll`}
              >
                          ...
                          return (
                            ...
                            >
                             <span> {slot.name}</span>
                              ...
                              <Button variant={"secondary"}><Pencil className="h-1 w-1"/></Button>
                                <Button variant={"ghost"}><X className="h-1 w-1"/></Button>
                            </Badge>
                          );
                        })}
                      </CardContent>
