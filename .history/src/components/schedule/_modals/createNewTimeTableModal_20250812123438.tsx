          ...
          <div className="grid gap-4 py-4">
                    ...
                    onSelect={(selected) => {
                      if (selected) {
                        ...
                        if(newDate in examSlots){
                          setToastMessage({message:"Day already scheduled", variant:"danger"})
                        }else{
                              setNewDay({
                          ...newDay,
                          date:newDate ,
            ...
            <div className="flex flex-col gap-2">
              {newDay.slots.map((myslot, index) => {
                return (
                  <div key={myslot.id} className="flex flex-col gap-1 border shadow-md border-foreground rounded-md p-2">
