        ...
        >
          ...
          {(windowView.split || windowView.slotsOnly) && (
            <div className={`${windowView.slotsOnly ? "w-full" : ""}`}>
              <div className="flex justify-center">
               <h2 className="text-center py-2 px-3 text-2xl font-bold"> Examination Slots</h2>
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-6 w-6 p-1 relative top-1 right-80"
                   
                >
                  <Plus className="h-3 w-3" /> Add new Day
                </Button>
              </div>
              {examSlots ? (
                <div
