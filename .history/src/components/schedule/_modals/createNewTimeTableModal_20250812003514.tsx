...
export default function CreateNewTimeTableModal() {
  ...
  return (
    <div className={`grid grid-cols-2`}>
      ...
      >
        <div className="text-center py-4 px-3 text-2xl font-bold">Create New Exam Schedule</div>
      ...
      <div className="">
        ...
        ):   <div className="text-center py-4 px-3"> No Dates selected yet! select start and end date and then generate slots</div>}
      </div>
    </div>
  );
}
