...
export default function CreateNewTimeTableModal() {
  ...
  <div className="flex gap-1 items-center border rounded-md p-1 shadow-sm">
    <Button
      ...
      size="sm"
      onClick={() => setWindowView({ formOnly: true, split: false, slotsOnly: false })}
    >
      Form Only
    </Button>
    <Button
      ...
      size="sm"
      onClick={() => setWindowView({ formOnly: false, split: true, slotsOnly: false })}
    >
      Split
    </Button>
    <Button
      ...
      size="sm"
      onClick={() => setWindowView({ formOnly: false, split: false, slotsOnly: true })}
    >
      Slots Only
    </Button>
  </div>
