...
export default function CreateNewTimeTableModal() {
  ...
  return (
    <form
      className="flex flex-col gap-4 p-2 sm:max-w-[800px] max-h-[100vh] overflow-y-auto"
    ...
    >
   {
    ...
    <Label htmlFor="start_date">Courses</Label>  
      ...
      <div className="grid grid-cols-2 gap-2">
        <div >
          <Label htmlFor="start_date" className="p-5">Start Date</Label>
      <Popover>
      ...
      <div className="">
        <Label htmlFor="end_date" className="p-5">End Date</Label>
      <Popover>
        <PopoverTrigger asChild>
          <Button
            variant={"outline"}
