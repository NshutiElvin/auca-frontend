...
function ServerLoader() {
  ...
  // useEffect(() => {
  //   if (serverLoadingMessage?.message && serverLoadingMessage.isServerLoading) {
  //     const timer = setTimeout(() => {
  //       setServerLoadingMessage({message:"", isServerLoading:false});
  //     }, 5000);
  ...
  return (
   serverLoadingMessage?.message && serverLoadingMessage.isServerLoading&& <div className={cn(
      "fixed z-50000 flex items-center gap-3 p-4 bg-background/80 backdrop-blur-sm rounded-lg shadow-lg border",
