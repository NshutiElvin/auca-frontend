...
function ServerLoader() {
  ...
  return (
    ...
    serverLoadingMessage.isServerLoading && (
      <div className="flex flex-col gap-3 p-0 m-0 bg-transparent backdrop-blur-sm rounded-lg shadow-lg border min-h-[100vh] top-0 min-w-full">
        <div
          className={cn(
            "md:top-4 md:right-4 md:translate-x-0 fixed z-50 flex items-center",
