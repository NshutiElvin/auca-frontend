    ...
    <Dialog open={dialogOpen} onOpenChange={handleDialogOpenChange}>
      <header  >
        <NavigationMenu className="mx-auto">
          <NavigationMenuList className={`container h-14 px-4 w-screen flex justify-between items-center ${ isScrolled 
          &&'bg-white/90 dark:bg-slate-900/90 backdrop-blur-lg border-b border-slate-200/50 dark:border-slate-800/50 shadow-lg shadow-black/5' 
          } `}>
