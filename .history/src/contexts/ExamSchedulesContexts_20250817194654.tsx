...
export const ExamscheduleProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  return (
    <examScheduleContext.Provider value={{ exams, setExams, unScheduled, setUnScheduled, status, setStatus, masterTimetable, setMasterTimetable, currentExamData, setCurrentExamData} 
